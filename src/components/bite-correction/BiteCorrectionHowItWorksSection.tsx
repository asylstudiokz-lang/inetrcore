          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Принято считать, что одной из основных причин возникновения неправильного прикуса является «плохая наследственность». Мы привыкли, что классическое исправление прикуса осуществляется только за счет работы с «фасадной частью» проблемы – через удаление «лишних» зубов, принудительное смещение зубов с использованием различных «жестких систем», и без исправления положения челюсти и расслабления мышц зубочелюстной системы. Отсюда частые рецидивы, когда по завершении лечения зубы «пытаются» вернуться в прежнее положение.
              </p>
              <p style={{
                fontFamily: "'Montserrat', sans-serif",
                fontSize: "13px", fontWeight: 400, lineHeight: 1.75,
                ...
                Не многие знают, что наши зубы выполняют малооцененную, но крайне важную функцию – функцию ночного антистресса (спазмирование и напряжение жевательных мышц, сопровождаемое сильным сжатием зубов).
              </p>
            </div>
          </div>
