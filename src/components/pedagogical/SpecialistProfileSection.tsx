...
export function SpecialistProfileSection() {
  ...
  return (
    <section className="relative overflow-hidden" style={{ backgroundColor: "#001d14" }}>
      {/* ── BACKGROUND ELEMENTS (Architectural Shapes) ── */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Scaled-Down Hexagon Overlay (Top-Right) */}
        <div 
          className="absolute right-[5%] top-[10%] w-[25%] h-[35%] opacity-[0.03] hidden lg:block"
          style={{
            background: CYAN,
        ...
        {/* Scaled-Down Triangle Overlay (Bottom-Left) */}
        <div 
          className="absolute left-[10%] bottom-[10%] w-[20%] h-[30%] opacity-[0.04] hidden lg:block"
          style={{
            background: `linear-gradient(135deg, ${CYAN} 0%, transparent 100%)`,
            clipPath: "polygon(100% 0, 100% 100%, 0 100%)",
            filter: "blur(20px)"
          }}
        />

        {/* Small Rhombus/Diamond (Center-Right) */}
        <div 
          className="absolute right-[15%] top-1/2 -translate-y-1/2 w-[12%] h-[18%] opacity-[0.03] hidden lg:block"
          style={{
            background: CYAN,
      ...
      <Container className="relative z-10 py-16 lg:py-24">
        {/* ── MOBILE HEADER (Above Photo) ── */}
        <div className="lg:hidden mb-12 text-center flex flex-col items-center">
            <p style={{ 
              fontFamily: "'Furore', sans-serif", fontSize: "12px", 
              color: CYAN, letterSpacing: "0.3em", textTransform: "uppercase", marginBottom: "16px",
              opacity: 0.8
            }}>
              Ваш специалист
            </p>
            <h3 style={{ 
              fontFamily: "'Furore', sans-serif", fontSize: "clamp(30px, 8vw, 40px)", 
              color: "#ffffff", textTransform: "uppercase", letterSpacing: "0.02em", lineHeight: 1.1,
              marginBottom: "24px"
            }}>
              Профессиональная помощь<br/>в развитии ребенка
            </h3>
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-20 lg:gap-16 xl:gap-24">
          ...
          <div className="w-full lg:w-[45%] max-w-[340px] lg:max-w-[540px]">
            <div className="group relative">
               ...
               }} className="group-hover:bg-[#6FE6C160]">
                  <div style={{ 
                    position: "relative",
                    background: "#00120a", 
                    clipPath: CLIP_PATH,
                    ...
                    <div className="flex flex-col items-center gap-4 text-center px-12 opacity-40 group-hover:opacity-60 transition-opacity">
                       ...
                       <p style={{ 
                         ...
                         color: CYAN, textTransform: "uppercase", letterSpacing: "0.2em"
                       }}>
                         Здесь будет<br/>фотография
                       </p>
                    </div>

                    {/* Scanline Effect */}
                    <div className="absolute inset-0 pointer-events-none opacity-10 bg-repeat-y" style={{ 
                      backgroundImage: "linear-gradient(to bottom, transparent 0, rgba(111,230,193,0.5) 1px, transparent 2px)", 
               ...
               {/* Name Tag Float */}
               <div className="absolute -bottom-4 -right-4 lg:-bottom-6 lg:-right-12 z-20 scale-[0.85] lg:scale-100 origin-bottom-right">
                  <div style={{
                    background: CYAN + "60",
                    ...
                    <div 
                      className="bg-[#00281e]/95 backdrop-blur-xl p-5 lg:p-8"
                      style={{ 
                        clipPath: "polygon(15px 0, 100% 0, 100% calc(100% - 15px), calc(100% - 15px) 100%, 0 100%, 0 15px)",
                      }}
                    >
                      <h2 style={{ 
                        fontFamily: "'Furore', sans-serif", fontSize: "24px", 
                        color: "#ffffff", textTransform: "uppercase", letterSpacing: "0.04em", lineHeight: 1.1
          ...
          <div className="w-full lg:w-[55%] flex flex-col">
             ...
             <div className="hidden lg:block mb-12">
                ...
                <h3 style={{ 
                  fontFamily: "'Furore', sans-serif", fontSize: "clamp(32px, 4vw, 48px)", 
                  color: "#ffffff", textTransform: "uppercase", letterSpacing: "0.02em", lineHeight: 1.1,
                  marginBottom: "24px"
                }}>
                  Профессиональная помощь<br/>в развитии ребенка
               ...
               {specialties.map((spec, i) => (
                 <div 
                   ...
                   style={{
                     ...
                     filter: hoveredCard === i ? `drop-shadow(0 0 10px ${CYAN}40)` : "none",
                   }}
                 >
                    <div style={{
                      ...
                      transition: "all 0.4s ease",
                       ...
                       <div className="flex items-center justify-between relative z-10">
                          <div style={{ 
                            ...
                            transition: "all 0.4s ease"
                             ...
                             <div style={{ color: CYAN, opacity: hoveredCard === i ? 1 : 0.7, filter: hoveredCard === i ? "brightness(1.2)" : "none" }}>
                                {spec.icon}
                             </div>
                          </div>
                          <div style={{ 
                       ...
                       <h4 style={{ 
                         fontFamily: "'Furore', sans-serif", fontSize: "18px", 
                         color: "#ffffff", 
                       ...
                       <p style={{ 
                         ...
                         color: hoveredCard === i ? "rgba(255,255,255,0.85)" : "rgba(255,255,255,0.6)", 
                         lineHeight: 1.5,
                         transition: "all 0.4s ease"
                       }}>
                         {spec.description}
                       ...
                       <div style={{ 
                         ...
                         transform: hoveredCard === i ? "translate(0,0)" : "translate(-4px,-4px)",
                         transition: "all 0.4s ease"
                       }} />
                       <div style={{ 
                         position: "absolute", bottom: "10px", right: "10px", 
                         width: "14px", height: "14px", 
                         borderBottom: `2.2px solid ${CYAN}`, 
                         borderRight: `2.2px solid ${CYAN}`,
