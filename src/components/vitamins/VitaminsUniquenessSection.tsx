...
const uniquenessItems = [
  {
    ...
    description: "Мы — первые, кто предлагает продукцию с комплексным подходом к восстановлению организма.",
    tag: "ГЛОБАЛЬНОСТЬ",
    isLarge: true,
  },
  {
    id: 2,
    title: "ИННОВАЦИОННАЯ ТЕХНОЛОГИЯ ПРОИЗВОДСТВА",
    description: "Разработана и запатентована нашей командой ученых, позволяет создавать продукты нового поколения.",
    tag: "ИННОВАЦИИ",
    isLarge: false,
  },
  {
    ...
    description: "Наша методика внедрена в России, Казахстане и за рубежом.",
    tag: "ЭТАЛОН",
    isLarge: false,
  },
  {
    ...
    description: "Восстановление организма на всех уровнях: от клеточного до системного — через натуральные, научно выверенные составы.",
    tag: "СИСТЕМНОСТЬ",
    isLarge: false,
  },
  {
    ...
    description: "Мы соединяем лучшие природные компоненты с последними достижениями биотехнологий и нутрициологии.",
    tag: "СИНТЕЗ",
    isLarge: false,
  },
];
