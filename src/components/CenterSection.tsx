        ...
        <Container>
          <div className="flex gap-16 items-center justify-center">
            ...
            <div className="flex-1 flex flex-col justify-center" style={{ paddingTop: "8px" }}>
              ...
              >
                Изобретатель, инноватор, врач-кардиохирург, врач-остеопат. Врач и инноватор, который открыл новые горизонты в вопросах восстановления организма. Его уникальные исследования в области анатомии, остеопатии и клеточной регуляции привели к созданию передовых методик лечения, в том числе революционного подхода к аутизму и нейродегенеративных заболеваний.
              </p>
